...
class TutorialListBlockService extends BaseBlockService
{
    protected $tutorialAdmin;
     ...
     */
    public function __construct($name, EngineInterface $templating, ContainerInterface $container, TutorialManagerInterface $tutorialManager)
    {
    ...
    {
        if (!$this->tutorialAdmin) {
            $this->tutorialAdmin = $this->container->get('rz_tutorial.admin.tutorial');
        }
    ...
    public function load(BlockInterface $block)
    {
        ...
        $tutorials = $this->tutorialManager->getPager(array(), 1, $settings['maxPerPage']);
